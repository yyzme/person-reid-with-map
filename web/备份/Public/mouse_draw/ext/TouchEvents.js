...
BM.Map.TouchExtend = BM.Handler.extend({
	...
	_touchEvent: function (e, type) {
		...
		// _filterClick is what bigemap uses as a workaround.
	...
	/** Borrowed from bigemap and modified for bool ops **/
...
BM.Marker.Touch = BM.Marker.extend({
	...
	// This is an exact copy of https://github.com/bigemap/bigemap/blob/v0.7/src/layer/marker/Marker.js
	...
	_initInteractionLegacy: function () {
		...
		BM.DomUtil.addClass(icon, 'bigemap-clickable');
