    ...
    */
    _getDirectionPoints: function(latLngs, pattern) {
        ...
        return projectPatternOnPointPath(pathAsPoints, pattern)
            .map(point => ({
                latLng: this._map.unproject(BM.point(point.pt)),
    ...
    */
    _getPatternLayers: function(pattern) {
        ...
        return this._paths.map(path => {
            ...
            return BM.featureGroup(this._buildSymbols(path, pattern.symbolFactory, directionPoints));
        });
    },
    ...
    */
    _draw: function () {
        this._patterns
            ...
            .forEach(layers => { this.addLayer(BM.featureGroup(layers)); });
    }
});
/*
