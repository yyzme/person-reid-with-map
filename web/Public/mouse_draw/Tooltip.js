...
BM.Draw.Tooltip = BM.Class.extend({
	...
	initialize: function (map) {
		...
		this._container = map.options.drawControlTooltips ?
			BM.DomUtil.create('div', 'bigemap-draw-tooltip', this._popupPane) : null;
	...
	updateContent: function (labelText) {
		...
		this._container.innerHTML =
			(labelText.subtext.length > 0 ?
				'<span class="bigemap-draw-tooltip-subtext">' + labelText.subtext + '</span>' + '<br />' : '') +
	...
	updatePosition: function (latlng) {
		...
		if (this._container) {
			...
			BM.DomUtil.setPosition(tooltipContainer, pos);
		}
