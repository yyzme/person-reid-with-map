...
BM.Edit.Rectangle = BM.Edit.SimpleShape.extend({
	...
	_onMarkerDragEnd: function (e) {
		...
		BM.Edit.SimpleShape.prototype._onMarkerDragEnd.call(this, e);
	},
	...
	_resize: function (latlng) {
		...
		this._shape.setBounds(BM.latLngBounds(latlng, this._oppositeCorner));
